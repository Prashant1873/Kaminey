    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Cross-examine the suspects. Tap any player to place them on the defense stand.
        </p>
      </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', textAlign: 'left' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '1.125rem', fontWeight: 800, color: 'var(--on-surface)' }}>
                {spotlightPlayer.name} is on the stand! State your defense!
              </div>
            </div>
          </div>
          <button
      ...
      <div>
        <div className="text-label" style={{ color: 'var(--on-surface-variant)', marginBottom: '12px' }}>
          TAP TO CALL SUSPECT TO STAND ({alivePlayers.length} PLAYERS ALIVE)
        </div>
        <div style={{
          display: 'grid',
      ...
      <div>
        ...
        >
          <span>End Debate: Open Secret Ballot</span>
          <ArrowRight size={20} />
        </button>
      </div>
    </div>
